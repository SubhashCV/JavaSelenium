...
public class Assn_DummyTicket {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("travname")).sendKeys("Duli"); //First name
		driver.findElement(By.id("travlastname")).sendKeys("Mahesh"); //Second name
		
		WebElement dobDatePicker = driver.findElement(By.id("dob"));
		selectDate(driver, dobDatePicker,"5","Jul","1985"); //date, month,year   //User defined method to select DOB.
		
		driver.findElement(By.xpath("//input[@name='sex'][@id='sex_1']")).click();
		...
		WebElement returnDateDatePicker=driver.findElement(By.id("returnDateDatePicker"));
		selectDate(driver, returnDateDatePicker, "15", "Nov", "2022");
